Feature: Verify the documentation for the advanced features in Selenium
 ...
 In order to shou you a way to commnicate with non technical stakeholder
 I want to introduce Cucumber in the demo
 ...
 Scenario: Selenium Page Object Design Pattern
   ...
   Then I should see the title "Test Design Consideration"